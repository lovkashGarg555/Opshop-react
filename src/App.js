           ...
           {/*{ dataComp} */}
            ...
            <div className="box" style={styleoneproduct}>
              ...
              <div className="box2" style={styleproductdetail}>
                ...
                <div className="price" style={styleproductprice}><span style={discount}>-62%</span><h3 className="text-[40px]">₹3698</h3>MRP : <span style={{ textDecoration: 'line-through' }}>₹7,999</span></div>
            ...
            <div className="box" style={styleoneproduct}>
              ...
              <div className="box2" style={styleproductdetail}>
                ...
                <div className="price"><discount style={discount}>-62%</discount><h3 className="text-[40px]">₹3699</h3> MRP: <span style={{ textDecoration: 'line-through' }}>₹7,999 </span> </div>
            ...
            <div className="box" style={styleoneproduct}>
              ...
              <div className="box2" style={styleproductdetail}>
                ...
                <div className="price"><discount style={discount}>-42%</discount><h3 className="text-[40px]">₹6999</h3>MRP:  <span style={{ textDecoration: 'line-through' }}>₹8,999</span></div>
            ...
            <div className="box" style={styleoneproduct}>
              ...
              <div className="box2" style={styleproductdetail}>
                ...
                <div className="price"><discount style={discount}>-52%</discount><h3 className="text-[40px]">₹4,099</h3>MRP:  <span style={{ textDecoration: 'line-through' }}>₹8,999</span> </div>
            ...
            <div className="box" style={styleoneproduct}>
              ...
              <div className="box2" style={styleproductdetail}>
                <div className="description">
                  <a href="" style={styledescription}><h3>ZEB-V19HD LED - LED Monitor - ZebronicsZEB-V19HD LED - LED Monitor - ZebronicsZEB-V19HD LED - LED Monitor ZEB-V19HD LED,
                    Slim design, glossy panel,Video resolution of 1400 x 900,VGA input,,Built-in power supply</h3></a></div>
                <div className="price"><discount style={discount}>-37%</discount><h3 className="text-[40px]">₹4299</h3>MRP:  <span style={{ textDecoration: 'line-through' }}>₹8,999</span>  </div>
            ...
            <div className="box" style={styleoneproduct}>
              ...
              <div className="box2" style={styleproductdetail}>
                ...
                <div className="price"><discount style={discount}>-62%</discount><h3 className="text-[40px]">₹4,699</h3>MRP:  <span style={{ textDecoration: 'line-through' }}>₹8,999</span>  </div>
                <div className="rating_availability"><h3>Rating :4.3</h3></div></div></div>
