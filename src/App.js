          ...
          <div className="box" style={styleoneproduct}>
            ...
            <div className="box2" style={styleproductdetail}>
              <div className="description" style={{margin:"3px 10px"}}>
                <a href="https://www.amazon.in/ZEBRONICS-ZEB-V19HD-LED-Supporting-Mountable/dp/B09GG4FT99/ref=sr_1_1?crid=5LY5FM65Q2BC&keywords=%28ZEBRONICS+ZEB-V19HD+LED+Monitor+18.5inch+with+Supporting+HDMI%2C+VGA+Input%2C+HD+1366+x+768%2C+16.7M+Colors%2C+Glossy+Panel%2C+Slim+Design+%26+Wall+Mountable%2C+Black%29&qid=1695313711&sprefix=zebronics+zeb-v19hd+led+monitor+18.5inch+with+supporting+hdmi%2C+vga+input%2C+hd+1366+x+768%2C+16.7m+colors%2C+glossy+panel%2C+slim+design+%26+wall+mountable%2C+black+%2Caps%2C192&sr=8-1" style={styledescription}><h3>{props.description}</h3></a></div>
